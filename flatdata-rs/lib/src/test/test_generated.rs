...
"#;
    ...
    impl<'a> std::fmt::Debug for BRef<'a> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_struct("B").field("id", &self.id()).finish()
        }
    }
    ...
    #[derive(Clone)]
    pub struct S {
        _storage: std::sync::Arc<dyn crate::ResourceStorage>,
    ...
    impl ::std::fmt::Debug for S {
        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
            f.debug_struct("S").field("data", &self.data()).finish()
        }
    }
    ...
    impl crate::Archive for S {
        ...
        fn open(
            storage: std::sync::Arc<dyn crate::ResourceStorage>,
    ...
    impl SBuilder {
        ...
        pub fn set_data(
            &self,
            resource: <super::test::A as crate::Struct>::Item,
        ) -> ::std::io::Result<()> {
            let data = unsafe {
                ::std::slice::from_raw_parts(
                    resource.as_ptr(),
                    <super::test::A as crate::Struct>::SIZE_IN_BYTES,
                )
            };
    ...
    impl ::std::fmt::Debug for Y {
        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
            f.debug_struct("Y").field("data", &self.data()).finish()
        }
    }
    ...
    impl YBuilder {
        ...
        pub fn set_data(&self, vector: &crate::ArrayView<super::test::R>) -> ::std::io::Result<()> {
            self.storage
                .write("data", schema::y::resources::DATA, vector.as_ref())
        }
    ...
    impl ::std::fmt::Debug for Z {
        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
            f.debug_struct("Z").field("ab", &self.ab()).finish()
        }
    }
    ...
    impl crate::Archive for Z {
        ...
        fn open(
            ...
            let ab = {
                ...
                let data = Self::read_resource(&*storage, "ab", schema::z::resources::AB)?;
                (index, data)
            };
    ...
    impl ::std::fmt::Debug for W {
        fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
            f.debug_struct("W").field("blob", &self.blob()).finish()
        }
    }
