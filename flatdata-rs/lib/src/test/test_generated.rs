...
use crate::{flatdata_read_bytes, flatdata_write_bytes};
...
impl S {
    ...
    {
        #[allow(unused_imports, unused_variables, clippy::useless_transmute, clippy::identity_op)]
        ...
        let data = {
            ...
            check("data", |_| 0, max_size, resource.and_then(super::test::A::from_bytes_slice))?
        };
...
impl X {
        ...
        -> ::std::result::Result<Self, crate::ResourceStorageError>
    {
        ...
        let data = {
            ...
            check("data", |r| r.len(), max_size, resource.and_then(<&[super::test::A]>::from_bytes))?
        };
...
impl Y {
        ...
        -> ::std::result::Result<Self, crate::ResourceStorageError>
    {
        ...
        let data = {
            ...
            check("data", |r| r.len(), max_size, resource.and_then(<&[super::test::R]>::from_bytes))?
        };
...
impl<'a> AbBuilder<'a> {
    ...
    /// [`A`]: struct.A.html
    #[inline]
    pub fn add_a(&mut self) -> &mut super::test::A {
    ...
    /// [`B`]: struct.B.html
    #[inline]
    pub fn add_b(&mut self) -> &mut super::test::B {
        let old_len = self.data.len();
...
impl crate::VariadicIndex for Ab {
    type Index = super::test::_builtin::multivector::IndexType16;
}
            ...
            let result = match (index, data) {
                (Ok(index), Ok(data)) => {
                    Ok(crate::MultiArrayView::new(
                        <&[super::test::_builtin::multivector::IndexType16]>::from_bytes(index)?,
                        data
                    ))
                }
...
impl W {
        ...
        -> ::std::result::Result<Self, crate::ResourceStorageError>
    {
        ...
        let blob = {
            ...
            check("blob", |r| r.len(), max_size, resource.map(crate::RawData::new))?
        };
