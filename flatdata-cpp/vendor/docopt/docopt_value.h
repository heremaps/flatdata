...
private:
    ...
    void
    throwIfNotKind( Kind expected ) const
    {
        if ( kind == expected )
            return;
...
{
    size_t
    operator( )( docopt::value const& val ) const noexcept
    {
        return val.hash( );
    }
};
...
inline bool
operator==( value const& v1, value const& v2 )
{
    if ( v1.kind != v2.kind )
        return false;
