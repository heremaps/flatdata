...
func (v *U8) ToString() string {
    ...
    if v.descriptor != nil {
        buffer.WriteString(fmt.Sprintf(`"padding": %v`, v.GetPadding()))
        buffer.WriteString(",")
